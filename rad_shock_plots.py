...
if OPTION == 1:
    ...
    # x data
    x_v100 = get_basic_data(v100_file)['x']
    ...
    line_style = ['-', '-']
    tracer_data_list = get_tracers(v100_file, tracer_list)
    ...
    plot_style['insert-txt'] = [[r'\textbf{Hydrogen}', -0.65E+15, 3.5, 0],
                                [r'\textbf{Helium}', 1.7E+15, 3.5, 0],
                                [r'\textbf{Carbon}', -1.8E+15, 2.25, 0],
                                [r'\textbf{Nitrogen}', 3.4E+14, 2.25,0],
                                [r'\textbf{Oxygen}', -1.8E+15, 0.95, 0],
                                [r'\textbf{Neon}', 3.4E+14, 0.95, 0]]
