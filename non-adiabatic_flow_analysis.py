...
ax1.set_ylabel(r'$\rm log \, T (K)$', fontsize=14, labelpad=8)
...
ax1.plot(x_ldot, np.log10(get_temperature(low_den_cooltime_file)), label=r'$\rm Time \, t_2$',
           color='crimson', linestyle='--', linewidth=1.3)
...
ax2.plot(x_ldot, H0 / X_H, label=r'$\rm H$', linewidth=1.3, color='crimson', linestyle='--')
ax2.plot(x_ldot, H1p / X_H, label=r'$\rm H^{+}$', linewidth=1.3, color='darkblue', linestyle='--')
ax2.plot(x_ldot, He0 / X_He, label=r'$\rm He$', linewidth=1.3, linestyle='-', color='crimson')
ax2.plot(x_ldot, He1p / X_He, label=r'$\rm He^{+}$', linewidth=1.3, linestyle='-', color='darkgreen')
ax2.plot(x_ldot, He2p / X_He, label=r'$\rm He^{2+}$', linewidth=1.3, linestyle='-', color='darkblue')
...
ax3.plot(x_ldot, C0 / X_C, label=r'$\rm C$', linewidth=1.3, color='red')
ax3.plot(x_ldot, C1p / X_C, label=r'$\rm C^{+}$', linewidth=1.3, linestyle='--', color='darkblue')
...
ax3.plot(x_ldot, norm_C4p_smooth, label=r'$\rm C^{4+}$', linewidth=1.3, color='darkgreen', linestyle='-')
ax3.plot(x_ldot, C5p / X_C, label=r'$\rm C^{5+}$', linewidth=1.3, color='crimson', linestyle='--')
ax3.plot(x_ldot, C6p / X_C, label=r'$\rm C^{6+}$', linewidth=1.3, color='darkblue', linestyle='-')
