...
X_Ne = get_tracer(cx_off_cie_silo, "Tr029_X_Ne")
Ne0 = get_tracer(cx_off_cie_silo, "Tr030_Ne")
Ne1p = get_tracer(cx_off_cie_silo, "Tr031_Ne1p")
Ne2p = get_tracer(cx_off_cie_silo, "Tr032_Ne2p")
Ne3p = get_tracer(cx_off_cie_silo, "Tr033_Ne3p")
Ne4p = get_tracer(cx_off_cie_silo, "Tr034_Ne4p")
Ne5p = get_tracer(cx_off_cie_silo, "Tr035_Ne5p")
Ne6p = get_tracer(cx_off_cie_silo, "Tr036_Ne6p")
Ne7p = get_tracer(cx_off_cie_silo, "Tr037_Ne7p")
Ne8p = get_tracer(cx_off_cie_silo, "Tr038_Ne8p")
Ne9p = get_tracer(cx_off_cie_silo, "Tr039_Ne9p")
