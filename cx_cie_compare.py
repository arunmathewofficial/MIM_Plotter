...
axs[0].set_xlabel(r"\rmT (K)", fontsize=16)
...
axs[1].plot(temperature_cx_on, Si0 / X_Si, label="$\mathrm{Si}^{0}$", color='black', linestyle='--')
axs[1].plot(temperature_cx_on, Si1p / X_Si, label="$\mathrm{Si}^{+}$", color='black', linestyle='--')
axs[1].plot(temperature_cx_on, Si2p / X_Si, label="$\mathrm{Si}^{2+}$", color='black', linestyle='--')
axs[1].plot(temperature_cx_on, Si3p / X_Si, label="$\mathrm{Si}^{3+}$", color='black', linestyle='--')
axs[1].plot(temperature_cx_on, Si4p / X_Si, label="$\mathrm{Si}^{4+}$", color='black', linestyle='--')
axs[1].plot(temperature_cx_on, Si5p / X_Si, label="$\mathrm{Si}^{5+}$", color='black', linestyle='--')
axs[1].plot(temperature_cx_on, Si6p / X_Si, label="$\mathrm{Si}^{6+}$", color='black', linestyle='--')
axs[1].plot(temperature_cx_on, Si7p / X_Si, label="$\mathrm{Si}^{7+}$", color='black', linestyle='--')
axs[1].plot(temperature_cx_on, Si8p / X_Si, label="$\mathrm{Si}^{8+}$", color='black', linestyle='--')
axs[1].plot(temperature_cx_on, Si9p / X_Si, label="$\mathrm{Si}^{9+}$", color='black', linestyle='--')
axs[1].plot(temperature_cx_on, Si10p / X_Si, label="$\mathrm{Si}^{10+}$", color='black', linestyle='--')
axs[1].plot(temperature_cx_on, Si11p / X_Si, label="$\mathrm{Si}^{11+}$", color='black', linestyle='--')
axs[1].plot(temperature_cx_on, Si12p / X_Si, label="$\mathrm{Si}^{12+}$", color='black', linestyle='--')
axs[1].plot(temperature_cx_on, Si13p / X_Si, label="$\mathrm{Si}^{13+}$", color='black', linestyle='--')
axs[1].plot(temperature_cx_on, Si14p / X_Si, label="$\mathrm{Si}^{14+}$", color='black', linestyle='--')

axs[1].tick_params(labelsize=16)
axs[1].legend(fontsize=12, loc="lower right")
axs[1].set_ylabel(r"\rm Ionisation Fraction", fontsize=16)
axs[1].set_xlabel(r"\rmT (K)", fontsize=16)
