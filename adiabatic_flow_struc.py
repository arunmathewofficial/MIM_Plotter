...
ax[0].set_ylabel(r'$\rm \rho \, (10^{-22} g \, cm^{-3})$', fontsize=20)  # Adjust fontsize as needed
...
ax[1].set_ylabel(r'$\rm log \, T \, (K)$', fontsize=20)  # Adjust fontsize as needed
...
# Set label and ticks for secondary y-axis
ax[2].set_ylabel(r'$\rm P \, (10^{-9} \, dyne \, cm^{-2})$', fontsize=20, labelpad=18)  # Adjust fontsize as needed
...
# Plot velocity
ax[3].plot(x_high, (100/3 - get_velocityX(high_resolution_file) )/1.0E+07, color="darkgreen", linestyle='-', label=r'$T$', linewidth=2)
# Set label and ticks for secondary y-axis
ax[3].set_ylabel(r'$\rm v_x - v_{sh} \, (10^2 \, km\, s^{-1})$', fontsize=20)  # Adjust fontsize as needed
...
# Set label and ticks for secondary y-axis
ax[4].set_ylabel(r'$\rm B_y \, (10^{-6}\, G)$', fontsize=20, labelpad=12)  # Adjust fontsize as needed
